...
Процедура  ПодготовитьДанныеДляРасчетаДДСотр(ПараметрыОтчета, ЗаписьJSON)
	...
	ЗаписьJSON.ЗаписатьИмяСвойства("properties");
    ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:dataBookName","Потребность в бюджетных ассигнованиях на выплату денежного довольствия сотрудникам");
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:dataBookTemplate","mRG_0000114");
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:dataBookTemplateVersion",1);
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:intoRequest",false);
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:obasFormsCode","0000114");
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:obasFormsName","Потребность в бюджетных ассигнованиях на выплату денежного довольствия сотрудникам");
		УИД_Формы = Новый УникальныйИдентификатор;
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:obasFormsUuid",Строка(УИД_Формы));
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:planningMethod","ПМ");
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:promiseStatus","Д");
...
Процедура ЗаписатьРазделыОтчетаРасчетДДСотрудники(ПараметрыОтчета, ЗаписьJSON)
	...
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаКомпОтдыхаСотр(ПараметрыОтчета, ЗаписьJSON);  // Компенсация отдыха
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаФСБСотр(ПараметрыОтчета, ЗаписьJSON);  // ФСБ
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаКомпОтпускаСотр(ПараметрыОтчета, ЗаписьJSON);  // Компенсация отпуска
	ЗаписьJSON.ЗаписатьКонецОбъекта(); 
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаНочныеПраздничныеСотр(ПараметрыОтчета, ЗаписьJSON);  // Ночные, праздничные
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
		...
		ЗаписьJSON.ЗаписатьИмяСвойства("properties");
			ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
				ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", Строка(ПараметрыОтчета.КодРаздела));
                ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "1");  // ???
                ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowNumByRank");
                ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
                ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
                ЗаписатьСвойствоJSON(ЗаписьJSON, "имяСтроки_value", "строкаРасчета");
                ЗаписатьСвойствоJSON(ЗаписьJSON, "сумма1_value", "0.00");
	...
	Для Каждого стрПотребность Из ТаблицаПотребности Цикл  
		...
		ЗаписьJSON.ЗаписатьИмяСвойства("properties");
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
				...
				ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowExpense");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
...
Процедура ЗаписатьСтрокуРасчетОкладаСотр(ПараметрыОтчета, ЗаписьJSON, ПараметрыСтроки)
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
		...
		ЗаписьJSON.ЗаписатьНачалоОбъекта();
			ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
			ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "4");
			ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSalary");
			ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
			ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
...
Процедура ЗаписатьДанныеПоТарифамСотр(ЗаписьJSON, ОкладыПоДолжностям)
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:caption", "Расчет по должности");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSalarySubTablePost");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:hideCode", true);
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:name", "детализацияПоДолжности");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:order", 1);	
	ЗаписьJSON.ЗаписатьКонецОбъекта(); 
		...
		Если ОкладыПоДолжностям.Итог(КолонкаКоличество)>0 Тогда
			...
			Для Каждого стрТариф Из ОкладыПоДолжностям Цикл 
				...
				ЗаписьJSON.ЗаписатьИмяСвойства("properties");
					ЗаписьJSON.ЗаписатьНачалоОбъекта();	
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0");
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSalarySubTablePost");
						ЗаписатьСвойствоJSON(ЗаписьJSON, "количествоСлуж_value", Количество);
						ЗаписатьСвойствоJSON(ЗаписьJSON, "оклад_value", Оклад);
						ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаИтого_value", Количество * Оклад);
...
Процедура ЗаписатьДанныеПоЗваниямСотр(ЗаписьJSON, ОкладыПоЗваниям)
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:caption", "Расчет по званию");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSalarySubTableRank");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:hideCode", true);
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:name", "детализацияПоЗванию");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:order", 2);	
	ЗаписьJSON.ЗаписатьКонецОбъекта(); 
    ...
    ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
		...
		Для Каждого стрЗвание Из ОкладыПоЗваниям Цикл 
			...
			ЗаписьJSON.ЗаписатьИмяСвойства("properties");
				ЗаписьJSON.ЗаписатьНачалоОбъекта();	
					ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0");
					ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSalarySubTableRank");
...
Процедура ЗаполнитьУвеличОкладМОСотр(ПараметрыОтчета, ЗаписьJSON)
	...
	СоставСлужащих.Очистить();
	ДобавитьВСоставСтрокуВысшийСостав();
	ДобавитьВСоставСтрокуСтаршийСостав();
	ДобавитьВСоставСтрокуСреднийСостав();
...
Процедура ЗаполнитьУвеличОкладСотр(ПараметрыОтчета, ЗаписьJSON)
	...
	ДобавитьВСоставСтрокуСтаршийСостав();
	ДобавитьВСоставСтрокуСреднийСостав();
	ДобавитьВСоставСтрокуМладшийСостав();
	...
	Для Каждого стрСостав Из СоставСлужащих Цикл 
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "1");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeTitle");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "количествоСлуж_value", ЧислСлуж);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "среднПроцентНадбавки_value", срПроцентСлуж);
...
Процедура ЗаписатьДанныеПоПроцентамСотр(ЗаписьJSON, ТаблНадбавок, ПереченьНадбавок)
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:caption", "Расчет надбавки по должности");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeSubTable");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:hideCode", true);
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:name", "детализацияРасчет");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:order", 1);	
	ЗаписьJSON.ЗаписатьКонецОбъекта(); 
		...
		Если ТаблНадбавок.Итог(КолонкаКоличество) > 0 И  ТаблНадбавок.Итог(КолонкаНадбавка) > 0 Тогда
			...
			Для Каждого стрЗвание Из ТаблНадбавок Цикл 
				...
				ЗаписьJSON.ЗаписатьИмяСвойства("properties");
					ЗаписьJSON.ЗаписатьНачалоОбъекта();	
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0");
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeSubTable");
						ЗаписатьСвойствоJSON(ЗаписьJSON, "количествоСлуж_value", Количество);
						ЗаписатьСвойствоJSON(ЗаписьJSON, "надбавкаИмя_value", ИмяНадбавки);  
						ЗаписатьСвойствоJSON(ЗаписьJSON, "надбавкаКод_value", КодНадбавки);
						ЗаписатьСвойствоJSON(ЗаписьJSON, "размерНадбавки_value", Надбавка);
	...
	Для Каждого стрНадбавкаПрочие Из ТаблицаНадбавокПрочие Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeOther");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "имяВыплаты", стрНадбавкаПрочие.П000370000101);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "комментарий", стрНадбавкаПрочие.П000370000103);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "комментарийПрош", стрНадбавкаПрочие.П000370000105);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасхода", стрНадбавкаПрочие.П000370000102);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасходаПрошл", стрНадбавкаПрочие.П000370000104);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ЗаполнитьНадбавкаКомпОтдыхаСотр(ПараметрыОтчета, ЗаписьJSON)
	
	УИД_НадбавкаПрочие =  Строка(Новый УникальныйИдентификатор);
    ПараметрыЗаголовкаТаблицы = Новый Структура;
	ПараметрыЗаголовкаТаблицы.Вставить("name",  "51_КомпенсацияОтдыха");
	ПараметрыЗаголовкаТаблицы.Вставить("id", УИД_НадбавкаПрочие);
	ПараметрыЗаголовкаТаблицы.Вставить("caption", "Расчет надбавок: компенсация отдыха");
	ПараметрыЗаголовкаТаблицы.Вставить("defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeCompRest");
	ПараметрыЗаголовкаТаблицы.Вставить("hideCode", true);
	ПараметрыЗаголовкаТаблицы.Вставить("order", 51);   
	ОформитьЗаголовокТаблицы(ЗаписьJSON, ПараметрыЗаголовкаТаблицы);
	
	ТаблицаНадбавокПрочие = ПараметрыОтчета.ДанныеПоРазделам.П0003300001;
	...
	Для Каждого стрНадбавкаПрочие Из ТаблицаНадбавокПрочие Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeCompRest");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасхода", стрНадбавкаПрочие.П000330000102);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасходаПрошл", стрНадбавкаПрочие.П000330000104);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ЗаполнитьНадбавкаФСБСотр(ПараметрыОтчета, ЗаписьJSON)
	...
	ПараметрыЗаголовкаТаблицы.Вставить("id", УИД_НадбавкаФСБ);
	ПараметрыЗаголовкаТаблицы.Вставить("caption", "Расчет надбавок: Надбавки сотрудникам ФСБ");
	ПараметрыЗаголовкаТаблицы.Вставить("defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeFSB");
	ПараметрыЗаголовкаТаблицы.Вставить("hideCode", true);
	ПараметрыЗаголовкаТаблицы.Вставить("order", 19);   
	ОформитьЗаголовокТаблицы(ЗаписьJSON, ПараметрыЗаголовкаТаблицы);
	...
	Для Каждого стрНадбавкаФСБ Из ТаблицаНадбавокФСБ Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeFSB");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "имяВыплаты", стрНадбавкаФСБ.П000380000101);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасхода", стрНадбавкаФСБ.П000380000102);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ЗаполнитьНадбавкаКомпОтпускаСотр(ПараметрыОтчета, ЗаписьJSON)
	
	УИД_НадбавкаПрочие =  Строка(Новый УникальныйИдентификатор);
    ПараметрыЗаголовкаТаблицы = Новый Структура;
	ПараметрыЗаголовкаТаблицы.Вставить("name",  "52_КомпенсацияОтдыха");
	ПараметрыЗаголовкаТаблицы.Вставить("id", УИД_НадбавкаПрочие);
	ПараметрыЗаголовкаТаблицы.Вставить("caption", "Расчет надбавок: компенсация отдыха");
	ПараметрыЗаголовкаТаблицы.Вставить("defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeCompVacation");
	ПараметрыЗаголовкаТаблицы.Вставить("hideCode", true);
	ПараметрыЗаголовкаТаблицы.Вставить("order", 52);   
	ОформитьЗаголовокТаблицы(ЗаписьJSON, ПараметрыЗаголовкаТаблицы);
	
	ТаблицаНадбавокПрочие = ПараметрыОтчета.ДанныеПоРазделам.П0003900001;
	...
	Для Каждого стрНадбавкаПрочие Из ТаблицаНадбавокПрочие Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeCompVacation");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасхода", стрНадбавкаПрочие.П000390000102);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасходаПрошл", стрНадбавкаПрочие.П000390000104);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ЗаполнитьНадбавкаНочныеПраздничныеСотр(ПараметрыОтчета, ЗаписьJSON)
	
	УИД_НадбавкаПрочие =  Строка(Новый УникальныйИдентификатор);
    ПараметрыЗаголовкаТаблицы = Новый Структура;
	ПараметрыЗаголовкаТаблицы.Вставить("name",  "53_НадбавкаНочныеПраздничные");
	ПараметрыЗаголовкаТаблицы.Вставить("id", УИД_НадбавкаПрочие);
	ПараметрыЗаголовкаТаблицы.Вставить("caption", "Расчет надбавок: компенсация отдыха");
	ПараметрыЗаголовкаТаблицы.Вставить("defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeAdditionaDays");
	ПараметрыЗаголовкаТаблицы.Вставить("hideCode", true);
	ПараметрыЗаголовкаТаблицы.Вставить("order", 53);   
	ОформитьЗаголовокТаблицы(ЗаписьJSON, ПараметрыЗаголовкаТаблицы);
	
	ТаблицаНадбавокПрочие = ПараметрыОтчета.ДанныеПоРазделам.П0004000001;
	...
	Для Каждого стрНадбавкаПрочие Из ТаблицаНадбавокПрочие Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeAdditionaDays");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасхода", стрНадбавкаПрочие.П000400000102);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасходаПрошл", стрНадбавкаПрочие.П000400000104);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ПодготовитьДанныеДляРасчетаЗП(ПараметрыОтчета, ЗаписьJSON)
	...
	ЗаписьJSON.ЗаписатьИмяСвойства("properties");
    ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:dataBookName","Потребность в бюджетных ассигнованиях на выплату заработной платы гражданскому персоналу");
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:dataBookTemplate","mRG_0000115");
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:dataBookTemplateVersion",1);
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:intoRequest",false);
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:obasFormsCode","0000115");
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:obasFormsName","Потребность в бюджетных ассигнованиях на выплату заработной платы гражданскому персоналу");
		УИД_Формы = Новый УникальныйИдентификатор;
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:obasFormsUuid",Строка(УИД_Формы));
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:planningMethod","ПМ");
    	ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:promiseStatus","Д");
...
Процедура ЗаписатьРазделыОтчетаЗПГражданские(ПараметрыОтчета, ЗаписьJSON)
	...
	СоставСлужащих.Очистить();               
	ДобавитьВСоставСтрокуГражданскиеФакт();
	ДобавитьВСоставСтрокуГражданскиеВакант();
	ДобавитьВСоставСтрокуГражданскиеВоен();
	...
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаПрочиеГражд(ПараметрыОтчета, ЗаписьJSON);  // Расчет НСН Доп
	ЗаписьJSON.ЗаписатьКонецОбъекта(); 
	...
	Для Каждого стрПотребность Из ТаблицаПотребности Цикл  
		...
		ЗаписьJSON.ЗаписатьИмяСвойства("properties");
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
	            ...
	            ЗаписатьСвойствоJSON(ЗаписьJSON, "osgu_value", "211"); // кроме 211 - что еще может быть
	            ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0");
	            ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowTotal");
	            ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value","ФЭД");  // ???
	            ЗаписатьСвойствоJSON(ЗаписьJSON, "subject_value","180");   // ???
	            ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
	            ЗаписатьСвойствоJSON(ЗаписьJSON, "имяРасходов_value", ВидРасчета.Наименование);
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
		...
		ЗаписьJSON.ЗаписатьИмяСвойства("properties");
			ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
				ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", Строка(ПараметрыОтчета.КодРаздела));
                ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "1");  // ???
                ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowNumByRank");
                ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
                ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
                ЗаписатьСвойствоJSON(ЗаписьJSON, "имяСтроки_value", "строкаРасчета");
                ЗаписатьСвойствоJSON(ЗаписьJSON, "сумма1_value", "0.00");
	...
	Для Каждого стрПотребность Из ТаблицаПотребности Цикл  
		...
		ЗаписьJSON.ЗаписатьИмяСвойства("properties");
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
				...
				ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowExpense");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
...
Процедура ЗаписатьСтрокуРасчетОкладаГражд(ПараметрыОтчета, ЗаписьJSON, ПараметрыСтроки)
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
		...
		ЗаписьJSON.ЗаписатьНачалоОбъекта();
			ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
			ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "4");
			ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowSalary");
			ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
			ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
			ЗаписатьСвойствоJSON(ЗаписьJSON, "количествоПоДолжности_value", Численность);
...
Процедура ЗаписатьДанныеПоТарифамГражд(ЗаписьJSON, ОкладыПоДолжностям)
	...
	ЗаписьJSON.ЗаписатьИмяСвойства("properties");
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:caption", "Расчет по квал. группе / квал. уровню");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowSalarySubTablePost");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:hideCode", true);
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:name", "детализацияПоКвал");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:order", 1);	
	ЗаписьJSON.ЗаписатьКонецОбъекта(); 
	ЗаписьJSON.ЗаписатьИмяСвойства("nodes");
    ЗаписьJSON.ЗаписатьНачалоМассива();
		...
		Если ОкладыПоДолжностям.Итог(КолонкаКоличество)>0 Тогда
			...
			Для Каждого стрТариф Из ОкладыПоДолжностям Цикл 
				...
				ЗаписьJSON.ЗаписатьИмяСвойства("properties");
					ЗаписьJSON.ЗаписатьНачалоОбъекта();	
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0");
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowSalarySubTablePost");
...
Процедура ДобавитьСтрокиНадбавкиГражд(ЗаписьJSON, ПараметрыОтчета, ПараметрыДобавленияНадбавки, ПодразделЧисл = "00002", ПодразделСрПроц = "00003") 
	...
	Для Каждого стрСостав Из СоставСлужащих Цикл 
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьИмяСвойства("properties");
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowSurchargeTitle");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "количествоСлуж_value", ЧислСлуж);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "среднПроцентНадбавки_value", срПроцентСлуж);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "сумма1_value", "0.00");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "сумма2_value", "0.00");
...
Процедура ЗаписатьДанныеПоПроцентамГражд(ЗаписьJSON, ТаблНадбавок, ПереченьНадбавок)
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:caption", "Расчет надбавки по должности");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowSurchargeSubTable");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:hideCode", true);
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:name", "детализацияРасчет");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:order", 1);	
	ЗаписьJSON.ЗаписатьКонецОбъекта(); 
		...
		Если ТаблНадбавок.Итог(КолонкаКоличество) > 0 И  ТаблНадбавок.Итог(КолонкаНадбавка) > 0 Тогда
			...
			Для Каждого стрЗвание Из ТаблНадбавок Цикл 
				...
				ЗаписьJSON.ЗаписатьИмяСвойства("properties");
					ЗаписьJSON.ЗаписатьНачалоОбъекта();	
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0");
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowSurchargeSubTable");
						ЗаписатьСвойствоJSON(ЗаписьJSON, "количествоСлуж_value", Количество);
						ЗаписатьСвойствоJSON(ЗаписьJSON, "надбавкаИмя_value", ИмяНадбавки);  
						ЗаписатьСвойствоJSON(ЗаписьJSON, "надбавкаКод_value", КодНадбавки);
						ЗаписатьСвойствоJSON(ЗаписьJSON, "размерНадбавки_value", Надбавка);
...
Процедура ЗаписатьСтрокуРасчетНСНГражд(ПараметрыОтчета, ЗаписьJSON, ПараметрыСтроки)
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
		...
		ЗаписьJSON.ЗаписатьНачалоОбъекта();
			ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
			ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "010014");
			ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowNSNTitle");
			ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
			ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
...
Процедура ЗаписатьДанныеПоТарифамНСНГражд(ЗаписьJSON, ОкладыПоДолжностям)
	...
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:caption", "Расчет по должности");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:defaultRowType", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowNSNSubTable");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:hideCode", true);
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:name", "детализацияРасчет");
		ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:order", 1);	
	ЗаписьJSON.ЗаписатьКонецОбъекта(); 
		...
		Если ОкладыПоДолжностям.Итог(КолонкаЧисленность)>0 Тогда
			...
			Для Каждого стрТариф Из ОкладыПоДолжностям Цикл 
				...
				ЗаписьJSON.ЗаписатьИмяСвойства("properties");
					ЗаписьJSON.ЗаписатьНачалоОбъекта();	
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0");
						ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowNSNSubTable");
	...
	Для Каждого стр Из ТаблицаНадбавок Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "0");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowNSNadd");
...
Процедура ЗаполнитьНадбавкаПрочиеГражд(ПараметрыОтчета, ЗаписьJSON)
	...
	ТаблицаНадбавок = ПараметрыОтчета.ДанныеПоРазделам.П0002700001; 
	
	Для Каждого стр Из ТаблицаНадбавок Цикл
		Если стр.П000270000102 = 0 И стр.П000270000104 = 0 Тогда
			Продолжить;
		КонецЕсли;
		ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln:rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000115.RowSurchargeOther");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "имяВыплаты", стр.П000270000101);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "комментарий", стр.П000270000103);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "комментарийПрош", стр.П000270000105);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасхода", стр.П000270000102);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасходаПрошл", стр.П000270000104);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ЗаполнитьНадбавкаРаботаВВыходныеГражд(ПараметрыОтчета, ЗаписьJSON)
	
	УИД_Раздела =  Строка(Новый УникальныйИдентификатор);
    ПараметрыЗаголовкаТаблицы = Новый Структура;
	ПараметрыЗаголовкаТаблицы.Вставить("name",  "НадбавкиВыходные");
	ПараметрыЗаголовкаТаблицы.Вставить("id", УИД_Раздела);
	ПараметрыЗаголовкаТаблицы.Вставить("caption", "Расчет надбавок: работа в выходные");
	ПараметрыЗаголовкаТаблицы.Вставить("defaultRowType", "");
	ПараметрыЗаголовкаТаблицы.Вставить("hideCode", true);
	ПараметрыЗаголовкаТаблицы.Вставить("order", 22);   
	ОформитьЗаголовокТаблицы(ЗаписьJSON, ПараметрыЗаголовкаТаблицы);
	
	ТаблицаНадбавок = ПараметрыОтчета.ДанныеПоРазделам.П0002800001; 
	
	Для Каждого стр Из ТаблицаНадбавок Цикл
		Если стр.П000280000102 = 0 И стр.П000280000103 = 0 Тогда
			Продолжить;
		КонецЕсли;
		ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
				...
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "имяВыплаты", стр.П000280000101);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасхода", стр.П000280000102);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасходаПрошл", стр.П000280000103);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ЗаполнитьНадбавкаКомпенсацияОтпускаГражд(ПараметрыОтчета, ЗаписьJSON)
	
	УИД_Раздела =  Строка(Новый УникальныйИдентификатор);
    ПараметрыЗаголовкаТаблицы = Новый Структура;
	ПараметрыЗаголовкаТаблицы.Вставить("name",  "НадбавкиКомпенсацияОтпуска");
	ПараметрыЗаголовкаТаблицы.Вставить("id", УИД_Раздела);
	ПараметрыЗаголовкаТаблицы.Вставить("caption", "Расчет надбавок: компенсация отпуска");
	ПараметрыЗаголовкаТаблицы.Вставить("defaultRowType", "");
	ПараметрыЗаголовкаТаблицы.Вставить("hideCode", true);
	ПараметрыЗаголовкаТаблицы.Вставить("order", 23);   
	ОформитьЗаголовокТаблицы(ЗаписьJSON, ПараметрыЗаголовкаТаблицы);
	
	ТаблицаНадбавок = ПараметрыОтчета.ДанныеПоРазделам.П0002900001; 
	...
	Для Каждого стр Из ТаблицаНадбавок Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
				...
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаПотребности", стр.П000290000102);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасходаПрошл", стр.П000290000103);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ЗаполнитьНадбавкаНеНормальныеУсловияТрудаГражд(ПараметрыОтчета, ЗаписьJSON)
	
	УИД_Раздела =  Строка(Новый УникальныйИдентификатор);
    ПараметрыЗаголовкаТаблицы = Новый Структура;
	ПараметрыЗаголовкаТаблицы.Вставить("name",  "НадбавкиНеНормальныеУсловияТруда");
	ПараметрыЗаголовкаТаблицы.Вставить("id", УИД_Раздела);
	ПараметрыЗаголовкаТаблицы.Вставить("caption", "Расчет надбавок: ненормальные условия труда");
	ПараметрыЗаголовкаТаблицы.Вставить("defaultRowType", "");
	ПараметрыЗаголовкаТаблицы.Вставить("hideCode", true);
	ПараметрыЗаголовкаТаблицы.Вставить("order", 24);   
	ОформитьЗаголовокТаблицы(ЗаписьJSON, ПараметрыЗаголовкаТаблицы);
	
	ТаблицаНадбавок = ПараметрыОтчета.ДанныеПоРазделам.П0003000001; 
	
	Для Каждого стр Из ТаблицаНадбавок Цикл
		Если стр.П000300000102 = 0 И стр.П000300000103 = 0 Тогда
			Продолжить;
		КонецЕсли;
		ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
				...
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "имяВыплаты", стр.П000300000101);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасхода", стр.П000300000102);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасходаПрошл", стр.П000300000103);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "пояснения", стр.П000300000104);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ЗаполнитьНадбавкаСовмещениеПрофессийГражд(ПараметрыОтчета, ЗаписьJSON)
	
	УИД_Раздела =  Строка(Новый УникальныйИдентификатор);
    ПараметрыЗаголовкаТаблицы = Новый Структура;
	ПараметрыЗаголовкаТаблицы.Вставить("name",  "НадбавкиСовмещениеПрофессий");
	ПараметрыЗаголовкаТаблицы.Вставить("id", УИД_Раздела);
	ПараметрыЗаголовкаТаблицы.Вставить("caption", "Расчет надбавок: совмещение профессий");
	ПараметрыЗаголовкаТаблицы.Вставить("defaultRowType", "");
	ПараметрыЗаголовкаТаблицы.Вставить("hideCode", true);
	ПараметрыЗаголовкаТаблицы.Вставить("order", 25);   
	ОформитьЗаголовокТаблицы(ЗаписьJSON, ПараметрыЗаголовкаТаблицы);
	
	ТаблицаНадбавок = ПараметрыОтчета.ДанныеПоРазделам.П0003100001; 
	
	Для Каждого стр Из ТаблицаНадбавок Цикл
		Если стр.П000310000102 = 0 И стр.П000310000103 = 0 Тогда
			Продолжить;
		КонецЕсли;
		ЗаписьJSON.ЗаписатьНачалоОбъекта(); 
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
				...
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "имяВыплаты", стр.П000310000101);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасхода", стр.П000310000102);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "суммаРасходаПрошл", стр.П000310000103);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "пояснения", стр.П000310000104);
			ЗаписьJSON.ЗаписатьКонецОбъекта();
         ЗаписьJSON.ЗаписатьКонецОбъекта();
	КонецЦикла;
...
Процедура ДобавитьВСоставСтрокуВысшийСостав()
	стрСостав = СоставСлужащих.Добавить();
...
Процедура ДобавитьВСоставСтрокуСтаршийСостав()
	стрСостав = СоставСлужащих.Добавить();
...
Процедура ДобавитьВСоставСтрокуСреднийСостав()
	стрСостав = СоставСлужащих.Добавить();
...
Процедура ДобавитьВСоставСтрокуМладшийСостав()
	стрСостав = СоставСлужащих.Добавить();
...
Процедура ДобавитьВСоставСтрокуГражданскиеФакт()
	стрСостав = СоставСлужащих.Добавить();
...
Процедура ДобавитьВСоставСтрокуГражданскиеВакант()
	стрСостав = СоставСлужащих.Добавить();
...
Процедура ДобавитьВСоставСтрокуГражданскиеВоен()
	стрСостав = СоставСлужащих.Добавить();
