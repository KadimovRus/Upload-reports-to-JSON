	...
	Для Каждого стрНадбавкаПрочие Из ТаблицаНадбавокПрочие Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeOther");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
	...
	Для Каждого стрНадбавкаПрочие Из ТаблицаНадбавокПрочие Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeCompRest");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
	...
	Для Каждого стрНадбавкаФСБ Из ТаблицаНадбавокФСБ Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeFSB");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
	...
	Для Каждого стрНадбавкаПрочие Из ТаблицаНадбавокПрочие Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeCompVacation");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
	...
	Для Каждого стрНадбавкаПрочие Из ТаблицаНадбавокПрочие Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
			    ЗаписатьСвойствоJSON(ЗаписьJSON, "fkr_value", ПараметрыОтчета.КодРаздела);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_code", "3");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "pln_rowClassName", "ru.krista.planning.obas.methodicsRG.mRG_0000114.RowSurchargeAdditionaDays");
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
...
Процедура ЗаписатьРазделыОтчетаЗПГражданские(ПараметрыОтчета, ЗаписьJSON)
	...
	ЗаписьJSON.ЗаписатьКонецОбъекта();   
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаРаботаВВыходныеГражд(ПараметрыОтчета, ЗаписьJSON);  // Работа в выходные
	ЗаписьJSON.ЗаписатьКонецОбъекта();  
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаКомпенсацияОтпускаГражд(ПараметрыОтчета, ЗаписьJSON);  // Компенсация отпуска
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаНеНормальныеУсловияТрудаГражд(ПараметрыОтчета, ЗаписьJSON);  // Ненормальные условия
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаСовмещениеПрофессийГражд(ПараметрыОтчета, ЗаписьJSON);  // Совмещение профессий
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьНадбавкаШифрГражд(ПараметрыОтчета, ЗаписьJSON);  // Надбавка шифр
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	...
	Для Каждого стр Из ТаблицаНадбавок Цикл
		...
		Уид_Строки = Строка(Новый УникальныйИдентификатор);
			...
			ЗаписьJSON.ЗаписатьНачалоОбъекта();
				...
				ЗаписатьСвойствоJSON(ЗаписьJSON, "subekr_value", "ФЭД"); // ???
				ЗаписатьСвойствоJSON(ЗаписьJSON, "vr_value", ПараметрыОтчета.КодВидаРасходов);
				ЗаписатьСвойствоJSON(ЗаписьJSON, "имяВыплаты", Строка(стр.П000280000101));
