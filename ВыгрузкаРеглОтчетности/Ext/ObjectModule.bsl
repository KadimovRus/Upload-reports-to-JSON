...
Функция РезультатПреобразования(ПараметрыОтчета) Экспорт
	...
	Адрес  = ПоместитьВоВременноеХранилище(Новый ДвоичныеДанные(ПолныйПуть), АдресВременногоХранилища);
...
Процедура ЗаписатьДанныеПоПроцентамСКР(ЗаписьJSON, ТаблНадбавок)
		...
		Для Каждого стрЗвание Из ТаблНадбавок Цикл 
			...
			ЗаписьJSON.ЗаписатьИмяСвойства("properties");
				ЗаписьJSON.ЗаписатьНачалоОбъекта();	
					...
					ЗаписатьСвойствоJSON(ЗаписьJSON, "количествоСлуж_value", Количество);
					ЗаписатьСвойствоJSON(ЗаписьJSON, "надбавкаИмя_value", Строка(Надбавка));  //? нет название, только число
					ЗаписатьСвойствоJSON(ЗаписьJSON, "надбавкаКод_value", Строка(Надбавка));
...
Процедура ЗаписатьРазделыОтчетаРасчетДДСотрудники(ПараметрыОтчета, ЗаписьJSON)
	...
	ЗаписьJSON.ЗаписатьКонецОбъекта();
	ЗаписьJSON.ЗаписатьНачалоОбъекта();
	    ЗаполнитьУвеличОклМОСотр(ПараметрыОтчета, ЗаписьJSON);  // Увеличение окладов МО 
	ЗаписьJSON.ЗаписатьКонецОбъекта();
...
Процедура ЗаполнитьУвеличОклМОСотр(ПараметрыОтчета, ЗаписьJSON)
	...
	ДобавитьСтрокиНадбавки(ЗаписьJSON, ПараметрыОтчета, ПараметрыДобавленияНадбавки, "00003", "00004");
